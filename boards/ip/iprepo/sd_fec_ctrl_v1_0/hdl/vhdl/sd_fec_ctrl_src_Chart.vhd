-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\fec_ber_hw\sd_fec_ctrl_src_Chart.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: sd_fec_ctrl_src_Chart
-- Source Path: fec_ber_hw/Encoder Ctrl/Chart
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
USE work.sd_fec_ctrl_src_Encoder_Ctrl_pkg.ALL;

ENTITY sd_fec_ctrl_src_Chart IS
...
END sd_fec_ctrl_src_Chart;


ARCHITECTURE rtl OF sd_fec_ctrl_src_Chart IS
  ...
  SIGNAL m_axis_tdata_tmp                 : unsigned(7 DOWNTO 0);  -- uint8
  ...
  SIGNAL m_axis_tdata_reg                 : unsigned(7 DOWNTO 0);  -- ufix8
  ...
  SIGNAL m_axis_tdata_reg_next            : unsigned(7 DOWNTO 0);  -- ufix8
...
BEGIN
  ...
  lib_rfsoc_fec_c3_Chart_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
      state_reg <= INIT;
      -- Local
      ...
      --
      -- DATA Stream
      m_axis_tdata_reg <= to_unsigned(16#00#, 8);
      m_axis_tvalid_reg <= '0';
      --
      -- CTRL Stream
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      ...
      END IF;
    END IF;
  END PROCESS lib_rfsoc_fec_c3_Chart_process;

  lib_rfsoc_fec_c3_Chart_output : PROCESS (block_length_unsigned, count, ctrl_word_unsigned, load, loaded_ctrl, loaded_n,
       m_axis_ctrl_tdata_reg, m_axis_ctrl_tlast_reg, m_axis_ctrl_tvalid_reg,
       m_axis_tdata_reg, m_axis_tvalid_reg, n, s_axis_status_tready_reg,
       s_axis_tdata_unsigned, s_axis_tvalid, state_reg)
    ...
    CASE state_reg IS
      WHEN COUNT_DIN =>
        ...
        IF sf_internal_predicateOutput = '1' THEN 
          ...
          --
          -- DATA Stream
          m_axis_tdata_reg_next <= s_axis_tdata_unsigned;
        ...
        ELSE 
          ...
          ELSE 
            ...
            IF c_sf_internal_predicateOutput = '1' THEN 
              ...
              --
              -- DATA Stream
              m_axis_tdata_reg_next <= to_unsigned(16#00#, 8);
      ...
      WHEN OTHERS => 
        ...
        END IF;
    END CASE;
  END PROCESS lib_rfsoc_fec_c3_Chart_output;
  ...
  m_axis_tdata_tmp <= m_axis_tdata_reg_next;
  ...
  m_axis_tdata <= std_logic_vector(m_axis_tdata_tmp);
