-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\fec_ber_hw\awgn_channel_addr_decoder.vhd
-- Created: 2022-10-06 15:11:27
-- 
...
ARCHITECTURE rtl OF awgn_channel_addr_decoder IS
  ...
  SIGNAL decode_sel_aximm_awgn_reset_1_1  : std_logic;  -- ufix1
  ...
  SIGNAL reg_enb_aximm_awgn_reset_1_1     : std_logic;  -- ufix1
  SIGNAL data_reg_aximm_awgn_reset_1_1    : unsigned(31 DOWNTO 0);  -- ufix32
  SIGNAL decode_rd_aximm_awgn_reset_1_1   : unsigned(31 DOWNTO 0);  -- ufix32

BEGIN
  addr_sel_unsigned <= unsigned(addr_sel);

  
  decode_sel_aximm_awgn_reset_1_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0041#, 14) ELSE
      '0';
  ...
  reg_enb_aximm_awgn_reset_1_1 <= decode_sel_aximm_awgn_reset_1_1 AND wr_enb;

  reg_aximm_awgn_reset_1_1_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
      data_reg_aximm_awgn_reset_1_1 <= to_unsigned(0, 32);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' AND reg_enb_aximm_awgn_reset_1_1 = '1' THEN
        data_reg_aximm_awgn_reset_1_1 <= data_write_unsigned;
      END IF;
    END IF;
  END PROCESS reg_aximm_awgn_reset_1_1_process;


  
  decode_rd_aximm_awgn_reset_1_1 <= decode_rd_aximm_noise_std_1_1 WHEN decode_sel_aximm_awgn_reset_1_1 = '0' ELSE
      data_reg_aximm_awgn_reset_1_1;

  data_read <= std_logic_vector(decode_rd_aximm_awgn_reset_1_1);
  ...
  write_aximm_awgn_reset <= std_logic_vector(data_reg_aximm_awgn_reset_1_1);
