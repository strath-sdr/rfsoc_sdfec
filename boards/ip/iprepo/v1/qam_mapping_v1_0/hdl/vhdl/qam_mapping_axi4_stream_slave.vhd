-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\fec_ber_hw\qam_mapping_axi4_stream_slave.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: qam_mapping_axi4_stream_slave
-- Source Path: qam_mapping/qam_mapping_axi4_stream_slave
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY qam_mapping_axi4_stream_slave IS
...
END qam_mapping_axi4_stream_slave;


ARCHITECTURE rtl OF qam_mapping_axi4_stream_slave IS

  -- Component Declarations
  COMPONENT qam_mapping_fifo_data
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : qam_mapping_fifo_data
    USE ENTITY work.qam_mapping_fifo_data(rtl);
...
BEGIN
  u_qam_mapping_fifo_data_inst : qam_mapping_fifo_data
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
