-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\fec_ber_hw\qam_mapping_axi4_stream_master.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: qam_mapping_axi4_stream_master
-- Source Path: qam_mapping/qam_mapping_axi4_stream_master
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY qam_mapping_axi4_stream_master IS
...
END qam_mapping_axi4_stream_master;


ARCHITECTURE rtl OF qam_mapping_axi4_stream_master IS

  -- Component Declarations
  COMPONENT qam_mapping_fifo_data_OUT
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT qam_mapping_fifo_TLAST_OUT
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : qam_mapping_fifo_data_OUT
    USE ENTITY work.qam_mapping_fifo_data_OUT(rtl);

  FOR ALL : qam_mapping_fifo_TLAST_OUT
    USE ENTITY work.qam_mapping_fifo_TLAST_OUT(rtl);
...
BEGIN
  u_qam_mapping_fifo_data_OUT_inst : qam_mapping_fifo_data_OUT
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_qam_mapping_fifo_TLAST_OUT_inst : qam_mapping_fifo_TLAST_OUT
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
