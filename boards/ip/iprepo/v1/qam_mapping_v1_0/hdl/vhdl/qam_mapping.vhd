-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\fec_ber_hw\qam_mapping.vhd
...
ARCHITECTURE rtl OF qam_mapping IS
  ...
  COMPONENT qam_mapping_axi4_stream_slave
    PORT( clk                             :   IN    std_logic;  -- ufix1
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          AXI4_Stream_Slave_TDATA         :   IN    std_logic_vector(127 DOWNTO 0);  -- ufix128
  ...
  COMPONENT qam_mapping_axi4_stream_master
    PORT( clk                             :   IN    std_logic;  -- ufix1
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          AXI4_Stream_Master_TREADY       :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : qam_mapping_axi4_stream_slave
    USE ENTITY work.qam_mapping_axi4_stream_slave(rtl);

  FOR ALL : qam_mapping_dut
    USE ENTITY work.qam_mapping_dut(rtl);

  FOR ALL : qam_mapping_axi4_stream_master
    USE ENTITY work.qam_mapping_axi4_stream_master(rtl);
...
BEGIN
  ...
  u_qam_mapping_axi4_stream_slave_inst : qam_mapping_axi4_stream_slave
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
              enb => const_1_1,
  ...
  u_qam_mapping_dut_inst : qam_mapping_dut
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              ...
              s_axis_tdata => top_user_data,  -- ufix128
  ...
  u_qam_mapping_axi4_stream_master_inst : qam_mapping_axi4_stream_master
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
              enb => const_1_1,
  ...
  ip_timestamp <= unsigned'(X"83BADCC2");
  ...
  top_user_ready_1 <= s_axis_tready_sig;
