-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\fec_ber_hw\qam_mapping_fifo_TLAST_OUT.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: qam_mapping_fifo_TLAST_OUT
-- Source Path: qam_mapping/qam_mapping_axi4_stream_master/qam_mapping_fifo_TLAST_OUT
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY qam_mapping_fifo_TLAST_OUT IS
...
END qam_mapping_fifo_TLAST_OUT;


ARCHITECTURE rtl OF qam_mapping_fifo_TLAST_OUT IS

  -- Component Declarations
  COMPONENT qam_mapping_SimpleDualPortRAM_singlebit
  ...
  FOR ALL : qam_mapping_SimpleDualPortRAM_singlebit
    USE ENTITY work.qam_mapping_SimpleDualPortRAM_singlebit(rtl);
...
BEGIN
  ...
  u_qam_mapping_fifo_TLAST_OUT_classic_ram_singlebit : qam_mapping_SimpleDualPortRAM_singlebit
