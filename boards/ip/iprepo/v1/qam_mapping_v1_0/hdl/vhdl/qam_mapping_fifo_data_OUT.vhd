-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\fec_ber_hw\qam_mapping_fifo_data_OUT.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: qam_mapping_fifo_data_OUT
-- Source Path: qam_mapping/qam_mapping_axi4_stream_master/qam_mapping_fifo_data_OUT
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY qam_mapping_fifo_data_OUT IS
...
END qam_mapping_fifo_data_OUT;


ARCHITECTURE rtl OF qam_mapping_fifo_data_OUT IS

  -- Component Declarations
  COMPONENT qam_mapping_SimpleDualPortRAM_generic
  ...
  FOR ALL : qam_mapping_SimpleDualPortRAM_generic
    USE ENTITY work.qam_mapping_SimpleDualPortRAM_generic(rtl);
...
BEGIN
  ...
  u_qam_mapping_fifo_data_OUT_classic_ram_generic : qam_mapping_SimpleDualPortRAM_generic
