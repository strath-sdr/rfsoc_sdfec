-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\fec_ber_hw\sd_fec_ctrl_reset_sync.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: sd_fec_ctrl_reset_sync
-- Source Path: sd_fec_ctrl/sd_fec_ctrl_reset_sync
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY sd_fec_ctrl_reset_sync IS
  PORT( clk                               :   IN    std_logic;
        reset_in                          :   IN    std_logic;  -- ufix1
        reset_out                         :   OUT   std_logic  -- ufix1
        );
END sd_fec_ctrl_reset_sync;


ARCHITECTURE rtl OF sd_fec_ctrl_reset_sync IS
