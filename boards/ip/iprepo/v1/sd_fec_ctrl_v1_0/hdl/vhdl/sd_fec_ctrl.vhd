-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\fec_ber_hw\sd_fec_ctrl.vhd
...
ARCHITECTURE rtl OF sd_fec_ctrl IS

  -- Component Declarations
  COMPONENT sd_fec_ctrl_reset_sync
  ...
  COMPONENT sd_fec_ctrl_axi_lite
  ...
  FOR ALL : sd_fec_ctrl_reset_sync
    USE ENTITY work.sd_fec_ctrl_reset_sync(rtl);

  FOR ALL : sd_fec_ctrl_axi_lite
    USE ENTITY work.sd_fec_ctrl_axi_lite(rtl);

  FOR ALL : sd_fec_ctrl_dut
    USE ENTITY work.sd_fec_ctrl_dut(rtl);
...
BEGIN
  u_sd_fec_ctrl_reset_sync_inst : sd_fec_ctrl_reset_sync
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset_in => reset_before_sync,  -- ufix1
              reset_out => reset
              );

  u_sd_fec_ctrl_axi_lite_inst : sd_fec_ctrl_axi_lite
  ...
  u_sd_fec_ctrl_dut_inst : sd_fec_ctrl_dut
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
  ...
  ip_timestamp <= unsigned'(X"83BADCC0");
