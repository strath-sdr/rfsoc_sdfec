...
set_property core_revision 2112722217 [ipx::current_core]
...
ipx::add_file {doc/fec_ber_hw_ip_core_report.html} [ipx::get_file_groups xilinx_productguide -of_objects [ipx::current_core]]
set_property type {{html}} [ipx::get_files {doc/fec_ber_hw_ip_core_report.html} -of_objects [ipx::get_file_groups xilinx_productguide -of_objects [ipx::current_core]]]
...
# Package IP
ipx::archive_core {../ber_v1_1.zip} [ipx::current_core]
close_project
exit
