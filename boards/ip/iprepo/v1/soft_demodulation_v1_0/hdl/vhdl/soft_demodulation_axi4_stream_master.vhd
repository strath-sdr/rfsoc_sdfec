-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\fec_ber_hw\soft_demodulation_axi4_stream_master.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: soft_demodulation_axi4_stream_master
-- Source Path: soft_demodulation/soft_demodulation_axi4_stream_master
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY soft_demodulation_axi4_stream_master IS
...
END soft_demodulation_axi4_stream_master;


ARCHITECTURE rtl OF soft_demodulation_axi4_stream_master IS

  -- Component Declarations
  COMPONENT soft_demodulation_fifo_data_OUT
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT soft_demodulation_fifo_TLAST_OUT
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : soft_demodulation_fifo_data_OUT
    USE ENTITY work.soft_demodulation_fifo_data_OUT(rtl);

  FOR ALL : soft_demodulation_fifo_TLAST_OUT
    USE ENTITY work.soft_demodulation_fifo_TLAST_OUT(rtl);
...
BEGIN
  u_soft_demodulation_fifo_data_OUT_inst : soft_demodulation_fifo_data_OUT
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_soft_demodulation_fifo_TLAST_OUT_inst : soft_demodulation_fifo_TLAST_OUT
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
