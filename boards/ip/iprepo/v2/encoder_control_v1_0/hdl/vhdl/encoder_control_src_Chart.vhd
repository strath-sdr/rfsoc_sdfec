-- -------------------------------------------------------------
-- 
-- File Name: hdl_32bit\hdlsrc\fec_ber_hw_V2\encoder_control_src_Chart.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: encoder_control_src_Chart
-- Source Path: fec_ber_hw_V2/Encoder Ctrl/Chart
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
USE work.encoder_control_src_Encoder_Ctrl_pkg.ALL;

ENTITY encoder_control_src_Chart IS
...
END encoder_control_src_Chart;


ARCHITECTURE rtl OF encoder_control_src_Chart IS
  ...
  SIGNAL m_axis_tdata_tmp                 : unsigned(31 DOWNTO 0);  -- uint32
  ...
  SIGNAL m_axis_tdata_reg                 : unsigned(31 DOWNTO 0);  -- ufix32
  ...
  SIGNAL m_axis_tdata_reg_next            : unsigned(31 DOWNTO 0);  -- ufix32
...
BEGIN
  ...
  BEGIN
    IF reset = '1' THEN
      ...
      -- DATA Stream
      m_axis_tvalid_reg <= '0';
      m_axis_tdata_reg <= to_unsigned(0, 32);
      --
      -- CTRL Stream
        ...
        ELSE 
          ...
          ELSE 
            ...
            IF c_sf_internal_predicateOutput = '1' THEN 
              ...
              m_axis_tdata_reg_next <= to_unsigned(0, 32);
              --
              -- CTRL Stream
              m_axis_ctrl_tdata_reg_next <= to_unsigned(0, 32);
              m_axis_ctrl_tlast_reg_next <= '0';
