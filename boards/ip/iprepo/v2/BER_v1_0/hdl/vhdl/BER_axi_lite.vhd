-- -------------------------------------------------------------
-- 
-- File Name: hdl_32bits\hdlsrc\fec_ber_hw_V2\BER_axi_lite.vhd
...
ARCHITECTURE rtl OF BER_axi_lite IS

  -- Component Declarations
  COMPONENT BER_addr_decoder
  ...
  FOR ALL : BER_addr_decoder
    USE ENTITY work.BER_addr_decoder(rtl);

  FOR ALL : BER_axi_lite_module
    USE ENTITY work.BER_axi_lite_module(rtl);
  ...
  SIGNAL write_aximm_bit_count_reset_tmp  : std_logic_vector(31 DOWNTO 0);  -- ufix32
...
BEGIN
  u_BER_addr_decoder_inst : BER_addr_decoder
    PORT MAP( clk => AXI4_Lite_ACLK,  -- ufix1
              ...
              read_aximm_bit_error => read_aximm_bit_error,  -- ufix32
              read_aximm_bit_count => read_aximm_bit_count,  -- ufix32
              read_aximm_fifo_num => read_aximm_fifo_num,  -- ufix14
              data_read => top_data_read,  -- ufix32
              write_axi_enable => write_axi_enable,  -- ufix1
              write_aximm_bit_count_reset => write_aximm_bit_count_reset_tmp,  -- ufix32
              write_aximm_length => write_aximm_length_tmp  -- ufix32
              );

  u_BER_axi_lite_module_inst : BER_axi_lite_module
    PORT MAP( clk => AXI4_Lite_ACLK,  -- ufix1
  ...
  write_aximm_bit_count_reset <= write_aximm_bit_count_reset_tmp;
