-- -------------------------------------------------------------
-- 
-- File Name: hdl_32bits\hdlsrc\fec_ber_hw_V2\BER.vhd
...
ENTITY BER IS
  PORT( IPCORE_CLK                        :   IN    std_logic;  -- ufix1
        ...
        s_axis_decoded_tdata              :   IN    std_logic_vector(31 DOWNTO 0);  -- ufix32
        s_axis_orig_tvalid                :   IN    std_logic;  -- ufix1
        s_axis_orig_tdata                 :   IN    std_logic_vector(31 DOWNTO 0);  -- ufix32
...
ARCHITECTURE rtl OF BER IS
  ...
  SIGNAL aximm_fifo_num_sig               : std_logic_vector(13 DOWNTO 0);  -- ufix14
...
BEGIN
  ...
  u_BER_axi_lite_inst : BER_axi_lite
    PORT MAP( reset => reset,
              ...
              read_aximm_fifo_num => aximm_fifo_num_sig,  -- ufix14
  ...
  u_BER_dut_inst : BER_dut
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              ...
              s_axis_decoded_tdata => s_axis_decoded_tdata,  -- ufix32
              s_axis_orig_tvalid => s_axis_orig_tvalid,  -- ufix1
              s_axis_orig_tdata => s_axis_orig_tdata,  -- ufix32
              ce_out => ce_out_sig,  -- ufix1
              aximm_bit_error => aximm_bit_error_sig,  -- ufix32
              aximm_bit_count => aximm_bit_count_sig,  -- ufix32
              aximm_fifo_num => aximm_fifo_num_sig,  -- ufix14
              ber_intr => ber_intr_sig  -- ufix1
              );

  ip_timestamp <= unsigned'(X"83BE1139");
