-- -------------------------------------------------------------
-- 
-- File Name: hdl_32bits\hdlsrc\fec_ber_hw_V2\BER_src_Subsystem.vhd
...
-- Source Path: fec_ber_hw_V2/BER/Subsystem
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF BER_src_Subsystem IS
  ...
  SIGNAL original_unsigned                : unsigned(31 DOWNTO 0);  -- uint32
  SIGNAL original_1                       : unsigned(31 DOWNTO 0);  -- uint32
