-- -------------------------------------------------------------
-- 
-- File Name: hdl_32bits\hdlsrc\fec_ber_hw_V2\decoder_control_reset_sync.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: decoder_control_reset_sync
-- Source Path: decoder_control/decoder_control_reset_sync
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY decoder_control_reset_sync IS
  PORT( clk                               :   IN    std_logic;
        reset_in                          :   IN    std_logic;  -- ufix1
        reset_out                         :   OUT   std_logic  -- ufix1
        );
END decoder_control_reset_sync;


ARCHITECTURE rtl OF decoder_control_reset_sync IS
