-- -------------------------------------------------------------
-- 
-- File Name: hdl_32bits_hmm\hdlsrc\fec_ber_hw_V2\soft_demodulation_src_To_SSR_Q0.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: soft_demodulation_src_To_SSR_Q0
-- Source Path: fec_ber_hw_V2/Soft Demodulation/To SSR Q0
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY soft_demodulation_src_To_SSR_Q0 IS
  PORT( data_wide                         :   IN    std_logic_vector(127 DOWNTO 0);  -- ufix128
        data_ssr                          :   OUT   vector_of_std_logic_vector16(0 TO 7)  -- uint16 [8]
        );
END soft_demodulation_src_To_SSR_Q0;


ARCHITECTURE rtl OF soft_demodulation_src_To_SSR_Q0 IS
