-- -------------------------------------------------------------
-- 
-- File Name: hdl_32bits_hmm\hdlsrc\fec_ber_hw_V2\soft_demodulation_src_Subsystem5.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: soft_demodulation_src_Subsystem5
-- Source Path: fec_ber_hw_V2/Soft Demodulation/Soft Demodulation/Subsystem5
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY soft_demodulation_src_Subsystem5 IS
...
END soft_demodulation_src_Subsystem5;


ARCHITECTURE rtl OF soft_demodulation_src_Subsystem5 IS
  ...
  CONSTANT alpha1_D_Lookup_Table4_data    : vector_of_signed3(0 TO 3) := 
    (to_signed(16#3#, 3), to_signed(16#1#, 3), to_signed(-16#3#, 3), to_signed(-16#3#, 3));  -- sfix3 [4]
  CONSTANT alpha1_D_Lookup_Table5_data    : vector_of_signed3(0 TO 3) := 
    (to_signed(16#3#, 3), to_signed(16#1#, 3), to_signed(-16#1#, 3), to_signed(-16#1#, 3));  -- sfix3 [4]
