-- -------------------------------------------------------------
-- 
-- File Name: hdl_32bits_hmm\hdlsrc\fec_ber_hw_V2\soft_demodulation_src_latch1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: soft_demodulation_src_latch1
-- Source Path: fec_ber_hw_V2/Soft Demodulation/Subsystem2/latch1
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY soft_demodulation_src_latch1 IS
...
END soft_demodulation_src_latch1;


ARCHITECTURE rtl OF soft_demodulation_src_latch1 IS
