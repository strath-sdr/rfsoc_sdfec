-- -------------------------------------------------------------
-- 
-- File Name: hdl_32bits_hmm\hdlsrc\fec_ber_hw_V2\soft_demodulation_src_get_min2_block.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: soft_demodulation_src_get_min2_block
-- Source Path: fec_ber_hw_V2/Soft Demodulation/Soft Demodulation/Subsystem2/get_min2
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY soft_demodulation_src_get_min2_block IS
...
END soft_demodulation_src_get_min2_block;


ARCHITECTURE rtl OF soft_demodulation_src_get_min2_block IS
