-- -------------------------------------------------------------
-- 
-- File Name: hdl_32bits_hmm\hdlsrc\fec_ber_hw_V2\soft_demodulation_src_From_SSR2.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: soft_demodulation_src_From_SSR2
-- Source Path: fec_ber_hw_V2/Soft Demodulation/From SSR2
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY soft_demodulation_src_From_SSR2 IS
  PORT( data_ssr                          :   IN    vector_of_std_logic_vector32(0 TO 3);  -- uint32 [4]
        data_wide                         :   OUT   std_logic_vector(127 DOWNTO 0)  -- ufix128
        );
END soft_demodulation_src_From_SSR2;


ARCHITECTURE rtl OF soft_demodulation_src_From_SSR2 IS
