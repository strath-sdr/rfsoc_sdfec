-- -------------------------------------------------------------
-- 
-- File Name: hdl_32bits_hmm\hdlsrc\fec_ber_hw_V2\soft_demodulation_src_Subsystem4.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: soft_demodulation_src_Subsystem4
-- Source Path: fec_ber_hw_V2/Soft Demodulation/Soft Demodulation/Subsystem4
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY soft_demodulation_src_Subsystem4 IS
...
END soft_demodulation_src_Subsystem4;


ARCHITECTURE rtl OF soft_demodulation_src_Subsystem4 IS

  -- Constants
  CONSTANT alpha1_D_Lookup_Table_data     : vector_of_signed3(0 TO 3) := 
    (to_signed(-16#3#, 3), to_signed(-16#3#, 3), to_signed(-16#1#, 3), to_signed(-16#1#, 3));  -- sfix3 [4]
  CONSTANT alpha1_D_Lookup_Table2_data    : vector_of_signed3(0 TO 3) := 
    (to_signed(16#1#, 3), to_signed(16#1#, 3), to_signed(-16#1#, 3), to_signed(-16#1#, 3));  -- sfix3 [4]
  CONSTANT alpha1_D_Lookup_Table3_data    : vector_of_signed3(0 TO 3) := 
    (to_signed(16#3#, 3), to_signed(16#3#, 3), to_signed(-16#1#, 3), to_signed(-16#1#, 3));  -- sfix3 [4]
  CONSTANT alpha1_D_Lookup_Table4_data    : vector_of_signed3(0 TO 3) := 
    (to_signed(-16#3#, 3), to_signed(-16#3#, 3), to_signed(-16#3#, 3), to_signed(16#1#, 3));  -- sfix3 [4]
  CONSTANT alpha1_D_Lookup_Table5_data    : vector_of_signed3(0 TO 3) := 
    (to_signed(-16#1#, 3), to_signed(-16#1#, 3), to_signed(-16#3#, 3), to_signed(16#1#, 3));  -- sfix3 [4]
  ...
  SIGNAL alpha1_D_Lookup_Table3_k         : unsigned(1 DOWNTO 0);  -- ufix2
...
BEGIN
  ...
  alpha1_D_Lookup_Table1_out1 <= to_signed(-16#1#, 3);
  ...
  alpha1_D_Lookup_Table3_k <= to_unsigned(16#0#, 2) WHEN enb_unsigned = to_unsigned(16#0#, 2) ELSE
      to_unsigned(16#3#, 2) WHEN enb_unsigned = to_unsigned(16#3#, 2) ELSE
      enb_unsigned;
  alpha1_D_Lookup_Table3_out1 <= alpha1_D_Lookup_Table3_data(to_integer(alpha1_D_Lookup_Table3_k));
