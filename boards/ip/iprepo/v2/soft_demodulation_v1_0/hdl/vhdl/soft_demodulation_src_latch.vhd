-- -------------------------------------------------------------
-- 
-- File Name: hdl_32bits_hmm\hdlsrc\fec_ber_hw_V2\soft_demodulation_src_latch.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: soft_demodulation_src_latch
-- Source Path: fec_ber_hw_V2/Soft Demodulation/Subsystem2/latch
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY soft_demodulation_src_latch IS
...
END soft_demodulation_src_latch;


ARCHITECTURE rtl OF soft_demodulation_src_latch IS
