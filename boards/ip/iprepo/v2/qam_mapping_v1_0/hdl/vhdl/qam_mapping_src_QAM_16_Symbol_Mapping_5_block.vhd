-- -------------------------------------------------------------
-- 
-- File Name: hdl_32bits\hdlsrc\fec_ber_hw_V2\qam_mapping_src_QAM_16_Symbol_Mapping_5_block.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: qam_mapping_src_QAM_16_Symbol_Mapping_5_block
-- Source Path: fec_ber_hw_V2/QAM Mapping/QAM Mapping/N-Width QAM-16 Symbol Mapping Real/QAM-16 Symbol Mapping 5
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY qam_mapping_src_QAM_16_Symbol_Mapping_5_block IS
  PORT( bits                              :   IN    std_logic_vector(63 DOWNTO 0);  -- ufix64
        I                                 :   OUT   std_logic_vector(2 DOWNTO 0)  -- sfix3
        );
END qam_mapping_src_QAM_16_Symbol_Mapping_5_block;


ARCHITECTURE rtl OF qam_mapping_src_QAM_16_Symbol_Mapping_5_block IS
...
BEGIN
  ...
  Bit_Slice1_out1 <= bits_unsigned(41 DOWNTO 40);
