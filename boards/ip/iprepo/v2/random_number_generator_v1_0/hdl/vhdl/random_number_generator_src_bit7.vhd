-- -------------------------------------------------------------
-- 
-- File Name: hdl_32bits\hdlsrc\fec_ber_hw_V2\random_number_generator_src_bit7.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: random_number_generator_src_bit7
-- Source Path: fec_ber_hw_V2/Random Number Generator/Random Number Generator/bit7
-- Hierarchy Level: 2
-- 
...
ENTITY random_number_generator_src_bit7 IS
...
END random_number_generator_src_bit7;


ARCHITECTURE rtl OF random_number_generator_src_bit7 IS

  -- Constants
  CONSTANT VectorTDL_data                 : std_logic_vector(0 TO 12) := 
    ('0', '1', '0', '0', '1', '0', '1', '1', '1', '1', '1', '1', '1');  -- ufix1 [13]
