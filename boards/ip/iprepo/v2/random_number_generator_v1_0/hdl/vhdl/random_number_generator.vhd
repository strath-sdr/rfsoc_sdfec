-- -------------------------------------------------------------
-- 
-- File Name: hdl_32bits\hdlsrc\fec_ber_hw_V2\random_number_generator.vhd
...
-- Source Path: random_number_generator
-- Hierarchy Level: 0
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF random_number_generator IS
  ...
  COMPONENT random_number_generator_reset_sync
  ...
  COMPONENT random_number_generator_axi_lite
  ...
  COMPONENT random_number_generator_dut
    PORT( clk                             :   IN    std_logic;  -- ufix1
          reset                           :   IN    std_logic;
  ...
  FOR ALL : random_number_generator_reset_sync
    USE ENTITY work.random_number_generator_reset_sync(rtl);

  FOR ALL : random_number_generator_axi_lite
    USE ENTITY work.random_number_generator_axi_lite(rtl);

  FOR ALL : random_number_generator_dut
    USE ENTITY work.random_number_generator_dut(rtl);
...
BEGIN
  u_random_number_generator_reset_sync_inst : random_number_generator_reset_sync
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset_in => reset_before_sync,  -- ufix1
              reset_out => reset
              );

  u_random_number_generator_axi_lite_inst : random_number_generator_axi_lite
  ...
  u_random_number_generator_dut_inst : random_number_generator_dut
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
  ...
  ip_timestamp <= unsigned'(X"83BE0FE1");
