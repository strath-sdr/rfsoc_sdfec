-- -------------------------------------------------------------
-- 
-- File Name: hdl_32bits\hdlsrc\fec_ber_hw_V2\random_number_generator_src_bit2.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: random_number_generator_src_bit2
-- Source Path: fec_ber_hw_V2/Random Number Generator/Random Number Generator/bit2
-- Hierarchy Level: 2
-- 
...
ENTITY random_number_generator_src_bit2 IS
...
END random_number_generator_src_bit2;


ARCHITECTURE rtl OF random_number_generator_src_bit2 IS

  -- Constants
  CONSTANT VectorTDL_data                 : std_logic_vector(0 TO 12) := 
    ('1', '0', '1', '1', '0', '0', '0', '1', '0', '1', '0', '1', '1');  -- ufix1 [13]
