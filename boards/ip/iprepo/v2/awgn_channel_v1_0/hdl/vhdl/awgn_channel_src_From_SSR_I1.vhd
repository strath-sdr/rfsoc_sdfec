-- -------------------------------------------------------------
-- 
-- File Name: hdl_32bits\hdlsrc\fec_ber_hw_V2\awgn_channel_src_From_SSR_I1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: awgn_channel_src_From_SSR_I1
-- Source Path: fec_ber_hw_V2/AWGN Channel/From SSR I1
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY awgn_channel_src_From_SSR_I1 IS
  PORT( data_ssr                          :   IN    vector_of_std_logic_vector16(0 TO 7);  -- sfix16_En11 [8]
        data_wide                         :   OUT   std_logic_vector(127 DOWNTO 0)  -- ufix128
        );
END awgn_channel_src_From_SSR_I1;


ARCHITECTURE rtl OF awgn_channel_src_From_SSR_I1 IS
