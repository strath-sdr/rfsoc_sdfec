-- -------------------------------------------------------------
-- 
-- File Name: hdl_32bits\hdlsrc\fec_ber_hw_V2\awgn_channel_src_To_SSR_I.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: awgn_channel_src_To_SSR_I
-- Source Path: fec_ber_hw_V2/AWGN Channel/To SSR I
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY awgn_channel_src_To_SSR_I IS
  PORT( data_wide                         :   IN    std_logic_vector(47 DOWNTO 0);  -- ufix48
        data_ssr                          :   OUT   vector_of_std_logic_vector3(0 TO 15)  -- ufix3 [16]
        );
END awgn_channel_src_To_SSR_I;


ARCHITECTURE rtl OF awgn_channel_src_To_SSR_I IS
