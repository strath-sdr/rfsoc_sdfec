-- -------------------------------------------------------------
-- 
-- File Name: hdl_32bits\hdlsrc\fec_ber_hw_V2\awgn_channel_src_bit5_block23.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: awgn_channel_src_bit5_block23
-- Source Path: fec_ber_hw_V2/AWGN Channel/AWGN/Subsystem1/AWGN Generator4/Random Number Generator/bit5
-- Hierarchy Level: 5
-- 
...
ENTITY awgn_channel_src_bit5_block23 IS
...
END awgn_channel_src_bit5_block23;


ARCHITECTURE rtl OF awgn_channel_src_bit5_block23 IS

  -- Constants
  CONSTANT VectorTDL_data                 : std_logic_vector(0 TO 12) := 
    ('1', '0', '0', '0', '1', '0', '1', '1', '0', '1', '0', '0', '0');  -- ufix1 [13]
