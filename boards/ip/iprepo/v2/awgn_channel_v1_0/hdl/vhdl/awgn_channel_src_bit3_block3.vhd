-- -------------------------------------------------------------
-- 
-- File Name: hdl_32bits\hdlsrc\fec_ber_hw_V2\awgn_channel_src_bit3_block3.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: awgn_channel_src_bit3_block3
-- Source Path: fec_ber_hw_V2/AWGN Channel/AWGN/Subsystem/AWGN Generator2/Random Number Generator/bit3
-- Hierarchy Level: 5
-- 
...
ENTITY awgn_channel_src_bit3_block3 IS
...
END awgn_channel_src_bit3_block3;


ARCHITECTURE rtl OF awgn_channel_src_bit3_block3 IS

  -- Constants
  CONSTANT VectorTDL_data                 : std_logic_vector(0 TO 12) := 
    ('1', '1', '0', '1', '1', '0', '1', '1', '1', '1', '1', '0', '0');  -- ufix1 [13]
