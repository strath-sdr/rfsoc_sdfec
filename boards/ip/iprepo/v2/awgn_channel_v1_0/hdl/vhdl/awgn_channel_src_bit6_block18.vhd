-- -------------------------------------------------------------
-- 
-- File Name: hdl_32bits\hdlsrc\fec_ber_hw_V2\awgn_channel_src_bit6_block18.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: awgn_channel_src_bit6_block18
-- Source Path: fec_ber_hw_V2/AWGN Channel/AWGN/Subsystem1/AWGN Generator1/Random Number Generator1/bit6
-- Hierarchy Level: 5
-- 
...
ENTITY awgn_channel_src_bit6_block18 IS
...
END awgn_channel_src_bit6_block18;


ARCHITECTURE rtl OF awgn_channel_src_bit6_block18 IS

  -- Constants
  CONSTANT VectorTDL_data                 : std_logic_vector(0 TO 12) := 
    ('0', '1', '1', '0', '1', '0', '0', '1', '1', '1', '1', '0', '1');  -- ufix1 [13]
