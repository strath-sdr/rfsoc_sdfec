-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\fec_ber_hw\soft_demodulation_src_Subsystem4.vhd
...
-- Source Path: fec_ber_hw/Soft Demodulation/Soft Demodulation/Subsystem4
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF soft_demodulation_src_Subsystem4 IS
  ...
  CONSTANT alpha1_D_Lookup_Table_data     : vector_of_signed3(0 TO 3) := 
    (to_signed(16#1#, 3), to_signed(-16#3#, 3), to_signed(16#3#, 3), to_signed(16#3#, 3));  -- sfix3 [4]
  CONSTANT alpha1_D_Lookup_Table1_data    : vector_of_signed3(0 TO 3) := 
    (to_signed(16#1#, 3), to_signed(-16#3#, 3), to_signed(16#1#, 3), to_signed(16#1#, 3));  -- sfix3 [4]
...
BEGIN
  ...
  alpha1_D_Lookup_Table6_out1 <= to_signed(-16#1#, 3);
