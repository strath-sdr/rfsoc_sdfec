-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\fec_ber_hw\soft_demodulation_fifo_TLAST_OUT.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: soft_demodulation_fifo_TLAST_OUT
-- Source Path: soft_demodulation/soft_demodulation_axi4_stream_master/soft_demodulation_fifo_TLAST_OUT
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY soft_demodulation_fifo_TLAST_OUT IS
...
END soft_demodulation_fifo_TLAST_OUT;


ARCHITECTURE rtl OF soft_demodulation_fifo_TLAST_OUT IS

  -- Component Declarations
  COMPONENT soft_demodulation_SimpleDualPortRAM_singlebit
  ...
  FOR ALL : soft_demodulation_SimpleDualPortRAM_singlebit
    USE ENTITY work.soft_demodulation_SimpleDualPortRAM_singlebit(rtl);
...
BEGIN
  ...
  u_soft_demodulation_fifo_TLAST_OUT_classic_ram_singlebit : soft_demodulation_SimpleDualPortRAM_singlebit
