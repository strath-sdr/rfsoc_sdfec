-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\fec_ber_hw\soft_demodulation_fifo_data.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: soft_demodulation_fifo_data
-- Source Path: soft_demodulation/soft_demodulation_axi4_stream_slave/soft_demodulation_fifo_data
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY soft_demodulation_fifo_data IS
...
END soft_demodulation_fifo_data;


ARCHITECTURE rtl OF soft_demodulation_fifo_data IS
...
BEGIN
  ...
  u_soft_demodulation_fifo_data_classic_ram : soft_demodulation_SimpleDualPortRAM_generic
