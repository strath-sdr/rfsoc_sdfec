-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\fec_ber_hw\soft_demodulation_addr_decoder.vhd
...
BEGIN
  ...
  decode_rd_aximm_llr_max_1_1 <= decode_rd_ip_timestamp_1_1 WHEN decode_sel_aximm_llr_max_1_1 = '0' ELSE
  ...
  decode_sel_aximm_llr_mag_reset_1_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0040#, 14) ELSE
      '0';
  ...
  decode_sel_aximm_llr_scale_1_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0041#, 14) ELSE
      '0';
