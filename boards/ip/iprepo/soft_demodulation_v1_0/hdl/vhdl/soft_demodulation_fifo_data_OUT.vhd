-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\fec_ber_hw\soft_demodulation_fifo_data_OUT.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: soft_demodulation_fifo_data_OUT
-- Source Path: soft_demodulation/soft_demodulation_axi4_stream_master/soft_demodulation_fifo_data_OUT
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY soft_demodulation_fifo_data_OUT IS
...
END soft_demodulation_fifo_data_OUT;


ARCHITECTURE rtl OF soft_demodulation_fifo_data_OUT IS

  -- Component Declarations
  COMPONENT soft_demodulation_SimpleDualPortRAM_generic
  ...
  FOR ALL : soft_demodulation_SimpleDualPortRAM_generic
    USE ENTITY work.soft_demodulation_SimpleDualPortRAM_generic(rtl);
...
BEGIN
  ...
  u_soft_demodulation_fifo_data_OUT_classic_ram_generic : soft_demodulation_SimpleDualPortRAM_generic
