-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\fec_ber_hw\soft_demodulation_axi4_stream_slave.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: soft_demodulation_axi4_stream_slave
-- Source Path: soft_demodulation/soft_demodulation_axi4_stream_slave
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY soft_demodulation_axi4_stream_slave IS
...
END soft_demodulation_axi4_stream_slave;


ARCHITECTURE rtl OF soft_demodulation_axi4_stream_slave IS

  -- Component Declarations
  COMPONENT soft_demodulation_fifo_data
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : soft_demodulation_fifo_data
    USE ENTITY work.soft_demodulation_fifo_data(rtl);
...
BEGIN
  u_soft_demodulation_fifo_data_inst : soft_demodulation_fifo_data
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
