-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\book_example_v2\ber_src_BER.vhd
...
-- -------------------------------------------------------------
-- aximm_bit_error               ce_out        1.25e-08
-- aximm_bit_count               ce_out        1.25e-08
-- aximm_fifo_num                ce_out        1.25e-08
-- ber_intr                      ce_out        1.25e-08
-- -------------------------------------------------------------
-- 
-- -------------------------------------------------------------
...
-- 
-- Module: ber_src_BER
-- Source Path: book_example_v2/BER
-- Hierarchy Level: 0
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY ber_src_BER IS
  PORT( clk                               :   IN    std_logic;
        ...
        s_axis_decoded_tdata              :   IN    std_logic_vector(7 DOWNTO 0);  -- uint8
...
ARCHITECTURE rtl OF ber_src_BER IS
  ...
  SIGNAL HDL_FIFO_out4                    : std_logic_vector(16 DOWNTO 0);  -- ufix17
  SIGNAL s_axis_decoded_tdata_unsigned    : unsigned(7 DOWNTO 0);  -- uint8
  SIGNAL s_axis_decoded_tdata_1           : unsigned(7 DOWNTO 0);  -- uint8
  ...
  SIGNAL HDL_FIFO_out4_unsigned           : unsigned(16 DOWNTO 0);  -- ufix17
  SIGNAL delayMatch1_reg                  : vector_of_unsigned17(0 TO 2);  -- ufix17 [3]
  SIGNAL HDL_FIFO_out4_1                  : unsigned(16 DOWNTO 0);  -- ufix17
...
BEGIN
  ...
  BEGIN
    IF reset = '1' THEN
      s_axis_decoded_tdata_1 <= to_unsigned(16#00#, 8);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        Delay1_out1 <= s_axis_decoded_tdata_1;
      END IF;
    END IF;
