-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\book_example_v2\Random_Number_Gen_src_bit0.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Random_Number_Gen_src_bit0
-- Source Path: book_example_v2/Random Number Generator/Random Number Generator/bit0
-- Hierarchy Level: 2
-- 
...
ENTITY Random_Number_Gen_src_bit0 IS
...
END Random_Number_Gen_src_bit0;


ARCHITECTURE rtl OF Random_Number_Gen_src_bit0 IS

  -- Constants
  CONSTANT VectorTDL_data                 : std_logic_vector(0 TO 12) := 
    ('0', '1', '0', '1', '1', '0', '1', '0', '0', '0', '0', '0', '1');  -- ufix1 [13]
