-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\book_example\awgn_channel_src_bit0.vhd
...
-- Source Path: book_example/AWGN Channel/AWGN Generator/Random Number Generator/bit0
-- Hierarchy Level: 3
-- 
...
ARCHITECTURE rtl OF awgn_channel_src_bit0 IS
  ...
  CONSTANT VectorTDL_data                 : std_logic_vector(0 TO 12) := 
    ('1', '1', '1', '1', '1', '1', '0', '0', '1', '0', '0', '0', '0');  -- ufix1 [13]
