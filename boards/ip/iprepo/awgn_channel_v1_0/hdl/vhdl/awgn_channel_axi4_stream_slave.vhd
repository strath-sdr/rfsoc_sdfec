-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\book_example\awgn_channel_axi4_stream_slave.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: awgn_channel_axi4_stream_slave
-- Source Path: awgn_channel/awgn_channel_axi4_stream_slave
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY awgn_channel_axi4_stream_slave IS
...
END awgn_channel_axi4_stream_slave;


ARCHITECTURE rtl OF awgn_channel_axi4_stream_slave IS

  -- Component Declarations
  COMPONENT awgn_channel_fifo_data
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : awgn_channel_fifo_data
    USE ENTITY work.awgn_channel_fifo_data(rtl);

  -- Signals
  SIGNAL fifo_rd_ack                      : std_logic;  -- ufix1
  SIGNAL stream_in_user_data              : std_logic_vector(7 DOWNTO 0);  -- ufix8
...
BEGIN
  u_awgn_channel_fifo_data_inst : awgn_channel_fifo_data
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              ...
              Out_rsvd => stream_in_user_data,  -- ufix8
