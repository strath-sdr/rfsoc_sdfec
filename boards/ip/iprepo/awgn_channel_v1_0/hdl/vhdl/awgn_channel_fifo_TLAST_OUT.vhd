-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\book_example\awgn_channel_fifo_TLAST_OUT.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: awgn_channel_fifo_TLAST_OUT
-- Source Path: awgn_channel/awgn_channel_axi4_stream_master/awgn_channel_fifo_TLAST_OUT
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY awgn_channel_fifo_TLAST_OUT IS
...
END awgn_channel_fifo_TLAST_OUT;


ARCHITECTURE rtl OF awgn_channel_fifo_TLAST_OUT IS

  -- Component Declarations
  COMPONENT awgn_channel_SimpleDualPortRAM_singlebit
  ...
  FOR ALL : awgn_channel_SimpleDualPortRAM_singlebit
    USE ENTITY work.awgn_channel_SimpleDualPortRAM_singlebit(rtl);
...
BEGIN
  ...
  u_awgn_channel_fifo_TLAST_OUT_classic_ram_singlebit : awgn_channel_SimpleDualPortRAM_singlebit
