-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\book_example\awgn_channel_src_bit4.vhd
...
-- Source Path: book_example/AWGN Channel/AWGN Generator/Random Number Generator/bit4
-- Hierarchy Level: 3
-- 
...
ARCHITECTURE rtl OF awgn_channel_src_bit4 IS
  ...
  CONSTANT VectorTDL_data                 : std_logic_vector(0 TO 12) := 
    ('1', '1', '1', '1', '1', '0', '1', '1', '1', '0', '1', '0', '0');  -- ufix1 [13]
