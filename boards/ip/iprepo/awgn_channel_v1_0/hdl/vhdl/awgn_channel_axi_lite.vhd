-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\fec_ber_hw\awgn_channel_axi_lite.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: awgn_channel_axi_lite
-- Source Path: awgn_channel/awgn_channel_axi_lite
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY awgn_channel_axi_lite IS
...
END awgn_channel_axi_lite;


ARCHITECTURE rtl OF awgn_channel_axi_lite IS

  -- Component Declarations
  COMPONENT awgn_channel_addr_decoder
  ...
  COMPONENT awgn_channel_axi_lite_module
    PORT( clk                             :   IN    std_logic;  -- ufix1
          AXI4_Lite_ARESETN               :   IN    std_logic;  -- ufix1
          AXI4_Lite_AWADDR                :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
          AXI4_Lite_AWVALID               :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : awgn_channel_addr_decoder
    USE ENTITY work.awgn_channel_addr_decoder(rtl);

  FOR ALL : awgn_channel_axi_lite_module
    USE ENTITY work.awgn_channel_axi_lite_module(rtl);
  ...
  SIGNAL write_aximm_noise_std_tmp        : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL write_aximm_awgn_reset_tmp       : std_logic_vector(31 DOWNTO 0);  -- ufix32
...
BEGIN
  u_awgn_channel_addr_decoder_inst : awgn_channel_addr_decoder
    PORT MAP( clk => AXI4_Lite_ACLK,  -- ufix1
              ...
              write_aximm_noise_std => write_aximm_noise_std_tmp,  -- ufix32_En30
              write_aximm_awgn_reset => write_aximm_awgn_reset_tmp  -- ufix32
              );

  u_awgn_channel_axi_lite_module_inst : awgn_channel_axi_lite_module
    PORT MAP( clk => AXI4_Lite_ACLK,  -- ufix1
  ...
  write_aximm_noise_std <= write_aximm_noise_std_tmp;

  write_aximm_awgn_reset <= write_aximm_awgn_reset_tmp;
