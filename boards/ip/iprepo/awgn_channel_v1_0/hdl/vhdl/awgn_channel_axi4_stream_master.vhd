-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\book_example\awgn_channel_axi4_stream_master.vhd
-- Created: 2022-11-15 16:00:37
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: awgn_channel_axi4_stream_master
-- Source Path: awgn_channel/awgn_channel_axi4_stream_master
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY awgn_channel_axi4_stream_master IS
...
END awgn_channel_axi4_stream_master;


ARCHITECTURE rtl OF awgn_channel_axi4_stream_master IS

  -- Component Declarations
  COMPONENT awgn_channel_fifo_data_OUT
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT awgn_channel_fifo_TLAST_OUT
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : awgn_channel_fifo_data_OUT
    USE ENTITY work.awgn_channel_fifo_data_OUT(rtl);

  FOR ALL : awgn_channel_fifo_TLAST_OUT
    USE ENTITY work.awgn_channel_fifo_TLAST_OUT(rtl);
...
BEGIN
  u_awgn_channel_fifo_data_OUT_inst : awgn_channel_fifo_data_OUT
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_awgn_channel_fifo_TLAST_OUT_inst : awgn_channel_fifo_TLAST_OUT
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
