-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\fec_ber_hw\awgn_channel.vhd
...
ARCHITECTURE rtl OF awgn_channel IS
  ...
  COMPONENT awgn_channel_axi4_stream_slave
    PORT( clk                             :   IN    std_logic;  -- ufix1
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          AXI4_Stream_Slave_TDATA         :   IN    std_logic_vector(7 DOWNTO 0);  -- ufix8
  ...
  COMPONENT awgn_channel_axi4_stream_master
    PORT( clk                             :   IN    std_logic;  -- ufix1
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          AXI4_Stream_Master_TREADY       :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : awgn_channel_axi4_stream_slave
    USE ENTITY work.awgn_channel_axi4_stream_slave(rtl);

  FOR ALL : awgn_channel_dut
    USE ENTITY work.awgn_channel_dut(rtl);

  FOR ALL : awgn_channel_axi4_stream_master
    USE ENTITY work.awgn_channel_axi4_stream_master(rtl);
...
BEGIN
  ...
  u_awgn_channel_axi4_stream_slave_inst : awgn_channel_axi4_stream_slave
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
              enb => const_1_1,
  ...
  u_awgn_channel_dut_inst : awgn_channel_dut
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              ...
              s_axis_tdata => top_user_data,  -- ufix8
              ce_out => ce_out_sig,  -- ufix1
              m_axis_tvalid => m_axis_tvalid_sig,  -- ufix1
              m_axis_tdata => m_axis_tdata_sig  -- ufix32
              );

  u_awgn_channel_axi4_stream_master_inst : awgn_channel_axi4_stream_master
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
              enb => const_1_1,
  ...
  ip_timestamp <= unsigned'(X"83BADCC7");
