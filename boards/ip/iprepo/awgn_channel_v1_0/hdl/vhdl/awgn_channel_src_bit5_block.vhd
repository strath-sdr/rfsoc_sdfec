-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\book_example\awgn_channel_src_bit5_block.vhd
...
-- Source Path: book_example/AWGN Channel/AWGN Generator/Random Number Generator1/bit5
-- Hierarchy Level: 3
-- 
...
ARCHITECTURE rtl OF awgn_channel_src_bit5_block IS
  ...
  CONSTANT VectorTDL_data                 : std_logic_vector(0 TO 12) := 
    ('1', '0', '0', '0', '1', '1', '1', '0', '1', '1', '0', '1', '1');  -- ufix1 [13]
