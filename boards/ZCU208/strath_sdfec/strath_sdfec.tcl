...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net zynq_ultra_ps_e_0_pl_resetn0 [get_bd_pins clk_wiz/resetn] [get_bd_pins rst_clk_wiz_50M/ext_reset_in] [get_bd_pins rst_pl_clk0/ext_reset_in] [get_bd_pins zynq_ultra_ps_e_0/pl_resetn0]
