...
strathsdr.org:rfsoc_sdfec:soft_demodulation:1.5\
...
proc create_root_design { parentCell } {
  ...
  set ber [ create_bd_cell -type ip -vlnv strathsdr.org:rfsoc_sdfec:ber:1.3 ber ]

  # Create instance: clk_wiz_1, and set properties
  set clk_wiz_1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:clk_wiz:6.0 clk_wiz_1 ]
  set_property -dict [ list \
   CONFIG.CLKIN1_JITTER_PS {33.330000000000005} \
   CONFIG.CLKOUT1_JITTER {134.645} \
   CONFIG.CLKOUT1_PHASE_ERROR {302.315} \
   CONFIG.CLKOUT1_REQUESTED_OUT_FREQ {666} \
   CONFIG.CLKOUT2_JITTER {171.235} \
   CONFIG.CLKOUT2_PHASE_ERROR {302.315} \
   CONFIG.CLKOUT2_REQUESTED_OUT_FREQ {111} \
   ...
   CONFIG.MMCM_CLKFBOUT_MULT_F {111.000} \
  ...
  # Create instance: random_number_gen, and set properties
  set random_number_gen [ create_bd_cell -type ip -vlnv strathsdr.org:rfsoc_sdfec:Random_Number_Gen:1.0 random_number_gen ]

  # Create instance: rst_clk_wiz_222M, and set properties
  set rst_clk_wiz_222M [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 rst_clk_wiz_222M ]

  # Create instance: rst_pl_clk, and set properties
  set rst_pl_clk [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 rst_pl_clk ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.LDPC_Decode_Code_Definition {no_file_loaded} \
   CONFIG.LDPC_Decode_Max_Schedule {0} \
   CONFIG.LDPC_Decode_No_OPC {false} \
   CONFIG.LDPC_Decode_Overrides {false} \
   CONFIG.LDPC_Decode_Scale {12} \
  ...
  set soft_demodulation [ create_bd_cell -type ip -vlnv strathsdr.org:rfsoc_sdfec:soft_demodulation:1.5 soft_demodulation ]
  ...
  connect_bd_intf_net -intf_net FEC_Ctrl_0_m_axis [get_bd_intf_pins fec_ctrl_enc/m_axis] [get_bd_intf_pins sd_fec_enc/S_AXIS_DIN]
  connect_bd_intf_net -intf_net FEC_Ctrl_0_m_axis_ctrl [get_bd_intf_pins fec_ctrl_enc/m_axis_ctrl] [get_bd_intf_pins sd_fec_enc/S_AXIS_CTRL]
  connect_bd_intf_net -intf_net FEC_Ctrl_1_m_axis [get_bd_intf_pins fec_ctrl_dec/m_axis] [get_bd_intf_pins sd_fec_dec/S_AXIS_DIN]
  connect_bd_intf_net -intf_net FEC_Ctrl_1_m_axis_ctrl [get_bd_intf_pins fec_ctrl_dec/m_axis_ctrl] [get_bd_intf_pins sd_fec_dec/S_AXIS_CTRL]
  connect_bd_intf_net -intf_net Random_Number_Gen_0_m00_axis [get_bd_intf_pins fec_ctrl_enc/s_axis] [get_bd_intf_pins random_number_gen/m00_axis]
  connect_bd_intf_net -intf_net Random_Number_Gen_m01_axis [get_bd_intf_pins ber/s_axis_orig] [get_bd_intf_pins random_number_gen/m01_axis]
  connect_bd_intf_net -intf_net awgn_channel_0_m_axis [get_bd_intf_pins awgn_channel/m_axis] [get_bd_intf_pins soft_demodulation/s_axis]
  connect_bd_intf_net -intf_net axi_interconnect_0_M00_AXI [get_bd_intf_pins axi_interconnect_0/M00_AXI] [get_bd_intf_pins random_number_gen/AXI4_Lite]
  connect_bd_intf_net -intf_net axi_interconnect_0_M01_AXI [get_bd_intf_pins axi_interconnect_0/M01_AXI] [get_bd_intf_pins fec_ctrl_enc/AXI4_Lite]
  connect_bd_intf_net -intf_net axi_interconnect_0_M02_AXI [get_bd_intf_pins axi_interconnect_0/M02_AXI] [get_bd_intf_pins sd_fec_enc/S_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_0_M03_AXI [get_bd_intf_pins axi_interconnect_0/M03_AXI] [get_bd_intf_pins qam_mapping/AXI4_Lite]
  connect_bd_intf_net -intf_net axi_interconnect_0_M04_AXI [get_bd_intf_pins awgn_channel/AXI4_Lite] [get_bd_intf_pins axi_interconnect_0/M04_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_0_M05_AXI [get_bd_intf_pins axi_interconnect_0/M05_AXI] [get_bd_intf_pins soft_demodulation/AXI4_Lite]
  connect_bd_intf_net -intf_net axi_interconnect_0_M06_AXI [get_bd_intf_pins axi_interconnect_0/M06_AXI] [get_bd_intf_pins fec_ctrl_dec/AXI4_Lite]
  connect_bd_intf_net -intf_net axi_interconnect_0_M07_AXI [get_bd_intf_pins axi_interconnect_0/M07_AXI] [get_bd_intf_pins sd_fec_dec/S_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_0_M08_AXI [get_bd_intf_pins axi_interconnect_0/M08_AXI] [get_bd_intf_pins ber/AXI4_Lite]
  connect_bd_intf_net -intf_net axi_interconnect_0_M09_AXI [get_bd_intf_pins axi_intc/s_axi] [get_bd_intf_pins axi_interconnect_0/M09_AXI]
  connect_bd_intf_net -intf_net axis_data_fifo_0_M_AXIS [get_bd_intf_pins axis_data_fifo_0/M_AXIS] [get_bd_intf_pins qam_mapping/s_axis]
  connect_bd_intf_net -intf_net default_sysclk_c0_300mhz_1 [get_bd_intf_ports default_sysclk_c0_300mhz] [get_bd_intf_pins clk_wiz_1/CLK_IN1_D]
  connect_bd_intf_net -intf_net qam_mapping_0_m_axis [get_bd_intf_pins awgn_channel/s_axis] [get_bd_intf_pins qam_mapping/m_axis]
  connect_bd_intf_net -intf_net sd_fec_1_M_AXIS_DOUT [get_bd_intf_pins axis_data_fifo_0/S_AXIS] [get_bd_intf_pins sd_fec_enc/M_AXIS_DOUT]
  ...
  connect_bd_intf_net -intf_net sd_fec_dec_M_AXIS_STATUS [get_bd_intf_pins fec_ctrl_dec/s_axis_status] [get_bd_intf_pins sd_fec_dec/M_AXIS_STATUS]
  connect_bd_intf_net -intf_net sd_fec_enc_M_AXIS_STATUS [get_bd_intf_pins fec_ctrl_enc/s_axis_status] [get_bd_intf_pins sd_fec_enc/M_AXIS_STATUS]
  connect_bd_intf_net -intf_net soft_demodulation_0_m_axis [get_bd_intf_pins fec_ctrl_dec/s_axis] [get_bd_intf_pins soft_demodulation/m_axis]
  ...
  connect_bd_net -net ARESETN_1 [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins rst_clk_wiz_222M/interconnect_aresetn]
  connect_bd_net -net M00_ACLK_1 [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins rst_pl_clk/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0]
  connect_bd_net -net axi_intc_0_irq [get_bd_pins axi_intc/irq] [get_bd_pins zynq_ultra_ps_e_0/pl_ps_irq0]
  connect_bd_net -net ber_0_ber_intr [get_bd_pins ber/ber_intr] [get_bd_pins xlconcat_0/In2]
  connect_bd_net -net clk_wiz_0_clk_333M [get_bd_pins awgn_channel/AXI4_Lite_ACLK] [get_bd_pins awgn_channel/IPCORE_CLK] [get_bd_pins axi_intc/s_axi_aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins axi_interconnect_0/M02_ACLK] [get_bd_pins axi_interconnect_0/M03_ACLK] [get_bd_pins axi_interconnect_0/M04_ACLK] [get_bd_pins axi_interconnect_0/M05_ACLK] [get_bd_pins axi_interconnect_0/M06_ACLK] [get_bd_pins axi_interconnect_0/M07_ACLK] [get_bd_pins axi_interconnect_0/M08_ACLK] [get_bd_pins axi_interconnect_0/M09_ACLK] [get_bd_pins axis_data_fifo_0/s_axis_aclk] [get_bd_pins ber/AXI4_Lite_ACLK] [get_bd_pins ber/IPCORE_CLK] [get_bd_pins clk_wiz_1/clk_out2] [get_bd_pins fec_ctrl_dec/AXI4_Lite_ACLK] [get_bd_pins fec_ctrl_dec/IPCORE_CLK] [get_bd_pins fec_ctrl_enc/AXI4_Lite_ACLK] [get_bd_pins fec_ctrl_enc/IPCORE_CLK] [get_bd_pins qam_mapping/AXI4_Lite_ACLK] [get_bd_pins qam_mapping/IPCORE_CLK] [get_bd_pins random_number_gen/AXI4_Lite_ACLK] [get_bd_pins random_number_gen/IPCORE_CLK] [get_bd_pins rst_clk_wiz_222M/slowest_sync_clk] [get_bd_pins sd_fec_dec/m_axis_dout_aclk] [get_bd_pins sd_fec_dec/m_axis_status_aclk] [get_bd_pins sd_fec_dec/s_axi_aclk] [get_bd_pins sd_fec_dec/s_axis_ctrl_aclk] [get_bd_pins sd_fec_dec/s_axis_din_aclk] [get_bd_pins sd_fec_enc/m_axis_dout_aclk] [get_bd_pins sd_fec_enc/m_axis_status_aclk] [get_bd_pins sd_fec_enc/s_axi_aclk] [get_bd_pins sd_fec_enc/s_axis_ctrl_aclk] [get_bd_pins sd_fec_enc/s_axis_din_aclk] [get_bd_pins soft_demodulation/AXI4_Lite_ACLK] [get_bd_pins soft_demodulation/IPCORE_CLK]
  connect_bd_net -net clk_wiz_0_clk_667M [get_bd_pins clk_wiz_1/clk_out1] [get_bd_pins sd_fec_dec/core_clk] [get_bd_pins sd_fec_enc/core_clk]
  connect_bd_net -net clk_wiz_1_locked [get_bd_pins clk_wiz_1/locked] [get_bd_pins rst_clk_wiz_222M/dcm_locked]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins awgn_channel/AXI4_Lite_ARESETN] [get_bd_pins awgn_channel/IPCORE_RESETN] [get_bd_pins axi_intc/s_axi_aresetn] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/M01_ARESETN] [get_bd_pins axi_interconnect_0/M02_ARESETN] [get_bd_pins axi_interconnect_0/M03_ARESETN] [get_bd_pins axi_interconnect_0/M04_ARESETN] [get_bd_pins axi_interconnect_0/M05_ARESETN] [get_bd_pins axi_interconnect_0/M06_ARESETN] [get_bd_pins axi_interconnect_0/M07_ARESETN] [get_bd_pins axi_interconnect_0/M08_ARESETN] [get_bd_pins axi_interconnect_0/M09_ARESETN] [get_bd_pins axis_data_fifo_0/s_axis_aresetn] [get_bd_pins ber/AXI4_Lite_ARESETN] [get_bd_pins ber/IPCORE_RESETN] [get_bd_pins fec_ctrl_dec/AXI4_Lite_ARESETN] [get_bd_pins fec_ctrl_dec/IPCORE_RESETN] [get_bd_pins fec_ctrl_enc/AXI4_Lite_ARESETN] [get_bd_pins fec_ctrl_enc/IPCORE_RESETN] [get_bd_pins qam_mapping/AXI4_Lite_ARESETN] [get_bd_pins qam_mapping/IPCORE_RESETN] [get_bd_pins random_number_gen/AXI4_Lite_ARESETN] [get_bd_pins random_number_gen/IPCORE_RESETN] [get_bd_pins rst_clk_wiz_222M/peripheral_aresetn] [get_bd_pins sd_fec_dec/reset_n] [get_bd_pins sd_fec_enc/reset_n] [get_bd_pins soft_demodulation/AXI4_Lite_ARESETN] [get_bd_pins soft_demodulation/IPCORE_RESETN]
  connect_bd_net -net rst_pl_clk0_peripheral_aresetn [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins rst_pl_clk/peripheral_aresetn]
  connect_bd_net -net sd_fec_dec_interrupt [get_bd_pins sd_fec_dec/interrupt] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net sd_fec_enc_interrupt [get_bd_pins sd_fec_enc/interrupt] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins axi_intc/intr] [get_bd_pins xlconcat_0/dout]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_resetn0 [get_bd_pins clk_wiz_1/resetn] [get_bd_pins rst_clk_wiz_222M/ext_reset_in] [get_bd_pins rst_pl_clk/ext_reset_in] [get_bd_pins zynq_ultra_ps_e_0/pl_resetn0]
  ...
  assign_bd_address -offset 0xA0030000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_intc/S_AXI/Reg] -force
  ...
  assign_bd_address -offset 0xA0040000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs fec_ctrl_dec/AXI4_Lite/reg0] -force
  assign_bd_address -offset 0xA0050000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs fec_ctrl_enc/AXI4_Lite/reg0] -force
  assign_bd_address -offset 0xA0060000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs qam_mapping/AXI4_Lite/reg0] -force
  assign_bd_address -offset 0xA0020000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs random_number_gen/AXI4_Lite/reg0] -force
  assign_bd_address -offset 0xA00C0000 -range 0x00040000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs sd_fec_dec/S_AXI/PARAMS] -force
  assign_bd_address -offset 0xA0080000 -range 0x00040000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs sd_fec_enc/S_AXI/PARAMS] -force
