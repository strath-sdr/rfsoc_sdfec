...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.CLKOUT1_JITTER {66.460} \
   CONFIG.CLKOUT1_PHASE_ERROR {73.186} \
   CONFIG.CLKOUT1_REQUESTED_OUT_FREQ {666.66667} \
  ...
  connect_bd_intf_net -intf_net S00_AXI_1 [get_bd_intf_pins axi_interconnect_hpm0/M02_AXI] [get_bd_intf_pins ldpc_encoder/S00_AXI]
  ...
  connect_bd_intf_net -intf_net S00_AXI_3 [get_bd_intf_pins axi_interconnect_hpm0/S00_AXI] [get_bd_intf_pins zynq_ultra_ps_e_0/M_AXI_HPM0_FPD]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M00_AXI [get_bd_intf_pins axi_intc_0/s_axi] [get_bd_intf_pins axi_interconnect_hpm0/M00_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_0_M01_AXI [get_bd_intf_pins axi_interconnect_hpm0/M01_AXI] [get_bd_intf_pins ldpc_decoder/S00_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_ps_slave_M00_AXI [get_bd_intf_pins axi_interconnect_ps_slave/M00_AXI] [get_bd_intf_pins zynq_ultra_ps_e_0/S_AXI_HP2_FPD]
  ...
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins axi_intc_0/s_axi_aresetn] [get_bd_pins axi_interconnect_hpm0/M00_ARESETN] [get_bd_pins axi_interconnect_hpm0/M01_ARESETN] [get_bd_pins axi_interconnect_hpm0/M02_ARESETN] [get_bd_pins axi_interconnect_ps_slave/S00_ARESETN] [get_bd_pins axi_interconnect_ps_slave/S01_ARESETN] [get_bd_pins ldpc_decoder/peripheral_reset] [get_bd_pins ldpc_encoder/peripheral_reset] [get_bd_pins rst_clk_wiz_50M/peripheral_aresetn]
  connect_bd_net -net rst_pl_clk0_interconnect_aresetn [get_bd_pins axi_interconnect_hpm0/ARESETN] [get_bd_pins axi_interconnect_ps_slave/ARESETN] [get_bd_pins rst_pl_clk0/interconnect_aresetn]
  connect_bd_net -net rst_pl_clk0_peripheral_aresetn [get_bd_pins axi_interconnect_hpm0/S00_ARESETN] [get_bd_pins axi_interconnect_ps_slave/M00_ARESETN] [get_bd_pins rst_pl_clk0/peripheral_aresetn]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins axi_intc_0/intr] [get_bd_pins xlconcat_intr/dout]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_resetn0 [get_bd_pins rst_clk_wiz_50M/ext_reset_in] [get_bd_pins rst_pl_clk0/ext_reset_in] [get_bd_pins zynq_ultra_ps_e_0/pl_resetn0]

  # Create address segments
  assign_bd_address -offset 0xA0010000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs ldpc_decoder/axi_dma_ctrl/S_AXI_LITE/Reg] -force
  assign_bd_address -offset 0xA0030000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs ldpc_encoder/axi_dma_ctrl/S_AXI_LITE/Reg] -force
  ...
  assign_bd_address -offset 0xA0080000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs ldpc_encoder/axi_dma_data/S_AXI_LITE/Reg] -force
  ...
  assign_bd_address -offset 0xA0040000 -range 0x00040000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs ldpc_decoder/sd_fec/S_AXI/PARAMS] -force
  ...
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces ldpc_decoder/axi_dma_ctrl/Data_MM2S] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP4/HP2_DDR_LOW] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces ldpc_decoder/axi_dma_ctrl/Data_S2MM] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP4/HP2_DDR_LOW] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces ldpc_decoder/axi_dma_data/Data_MM2S] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP4/HP2_DDR_LOW] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces ldpc_decoder/axi_dma_data/Data_S2MM] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP4/HP2_DDR_LOW] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces ldpc_encoder/axi_dma_ctrl/Data_MM2S] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP4/HP2_DDR_LOW] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces ldpc_encoder/axi_dma_ctrl/Data_S2MM] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP4/HP2_DDR_LOW] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces ldpc_encoder/axi_dma_data/Data_MM2S] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP4/HP2_DDR_LOW] -force
