...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.CLKOUT1_JITTER {85.855} \
   CONFIG.CLKOUT1_PHASE_ERROR {82.655} \
   CONFIG.CLKOUT1_REQUESTED_OUT_FREQ {300} \
   CONFIG.CLKOUT2_JITTER {131.577} \
   CONFIG.CLKOUT2_PHASE_ERROR {105.692} \
  ...
  connect_bd_net -net zynq_ultra_ps_e_0_pl_resetn0 [get_bd_pins clk_wiz_0/resetn] [get_bd_pins clk_wiz_1/resetn] [get_bd_pins rst_clk_wiz_222M/ext_reset_in] [get_bd_pins rst_pl_clk/ext_reset_in] [get_bd_pins zynq_ultra_ps_e_0/pl_resetn0]
