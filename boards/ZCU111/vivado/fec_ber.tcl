...
if { $bCheckIPs == 1 } {
   set list_check_ips "\ 
strathsdr.org:rfsoc_sdfec:awgn_channel:1.0\
xilinx.com:ip:axi_intc:4.1\
strathsdr.org:rfsoc_sdfec:ber:1.0\
xilinx.com:ip:clk_wiz:6.0\
strathsdr.org:rfsoc_sdfec:qam_mapping:1.0\
strathsdr.org:rfsoc_sdfec:random_number_generator:1.0\
xilinx.com:ip:proc_sys_reset:5.0\
strathsdr.org:rfsoc_sdfec:sd_fec_ctrl:1.0\
xilinx.com:ip:sd_fec:1.1\
strathsdr.org:rfsoc_sdfec:soft_demodulation:1.0\
...
proc create_root_design { parentCell } {
  ...
  # Create instance: awgn_channel, and set properties
  set awgn_channel [ create_bd_cell -type ip -vlnv strathsdr.org:rfsoc_sdfec:awgn_channel:1.0 awgn_channel ]
  ...
  # Create instance: ber, and set properties
  set ber [ create_bd_cell -type ip -vlnv strathsdr.org:rfsoc_sdfec:ber:1.0 ber ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.CLK_OUT1_PORT {clk_640M} \
   CONFIG.CLK_OUT2_PORT {clk_320M} \
   CONFIG.CLK_OUT3_PORT {clk_20M} \
  ...
  set qam_mapping [ create_bd_cell -type ip -vlnv strathsdr.org:rfsoc_sdfec:qam_mapping:1.0 qam_mapping ]

  # Create instance: random_number_generator, and set properties
  set random_number_generator [ create_bd_cell -type ip -vlnv strathsdr.org:rfsoc_sdfec:random_number_generator:1.0 random_number_generator ]

  # Create instance: rst_clk_wiz_320M, and set properties
  set rst_clk_wiz_320M [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 rst_clk_wiz_320M ]

  # Create instance: rst_design_1_640M, and set properties
  set rst_design_1_640M [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 rst_design_1_640M ]
  ...
  # Create instance: sd_fec_ctrl_decoder, and set properties
  set sd_fec_ctrl_decoder [ create_bd_cell -type ip -vlnv strathsdr.org:rfsoc_sdfec:sd_fec_ctrl:1.0 sd_fec_ctrl_decoder ]

  # Create instance: sd_fec_ctrl_encoder, and set properties
  set sd_fec_ctrl_encoder [ create_bd_cell -type ip -vlnv strathsdr.org:rfsoc_sdfec:sd_fec_ctrl:1.0 sd_fec_ctrl_encoder ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.Example_Design_PS_Type {MicroBlaze} \
   ...
   CONFIG.LDPC_Encode_Code_Definition {no_file_loaded} \
  ...
  # Create instance: soft_demodulation, and set properties
  set soft_demodulation [ create_bd_cell -type ip -vlnv strathsdr.org:rfsoc_sdfec:soft_demodulation:1.0 soft_demodulation ]
  ...
  connect_bd_intf_net -intf_net awgn_channel_AXI4_Stream_Master [get_bd_intf_pins awgn_channel/AXI4_Stream_Master] [get_bd_intf_pins soft_demodulation/AXI4_Stream_Slave]
  connect_bd_intf_net -intf_net axi_interconnect_ps_master_M00_AXI [get_bd_intf_pins axi_interconnect_ps_master/M00_AXI] [get_bd_intf_pins sd_fec_enc/S_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_ps_master_M01_AXI [get_bd_intf_pins axi_interconnect_ps_master/M01_AXI] [get_bd_intf_pins sd_fec_dec/S_AXI]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_ps_master_M03_AXI [get_bd_intf_pins axi_interconnect_ps_master/M03_AXI] [get_bd_intf_pins random_number_generator/AXI4_Lite]
  connect_bd_intf_net -intf_net axi_interconnect_ps_master_M04_AXI [get_bd_intf_pins axi_interconnect_ps_master/M04_AXI] [get_bd_intf_pins sd_fec_ctrl_encoder/AXI4_Lite]
  connect_bd_intf_net -intf_net axi_interconnect_ps_master_M05_AXI [get_bd_intf_pins axi_interconnect_ps_master/M05_AXI] [get_bd_intf_pins sd_fec_ctrl_decoder/AXI4_Lite]
  connect_bd_intf_net -intf_net axi_interconnect_ps_master_M06_AXI [get_bd_intf_pins axi_interconnect_ps_master/M06_AXI] [get_bd_intf_pins qam_mapping/AXI4_Lite]
  connect_bd_intf_net -intf_net axi_interconnect_ps_master_M07_AXI [get_bd_intf_pins awgn_channel/AXI4_Lite] [get_bd_intf_pins axi_interconnect_ps_master/M07_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_ps_master_M08_AXI [get_bd_intf_pins axi_interconnect_ps_master/M08_AXI] [get_bd_intf_pins soft_demodulation/AXI4_Lite]
  connect_bd_intf_net -intf_net axi_interconnect_ps_master_M09_AXI [get_bd_intf_pins axi_interconnect_ps_master/M09_AXI] [get_bd_intf_pins ber/AXI4_Lite]
  ...
  connect_bd_intf_net -intf_net qam_mapping_AXI4_Stream_Master [get_bd_intf_pins awgn_channel/AXI4_Stream_Slave] [get_bd_intf_pins qam_mapping/AXI4_Stream_Master]
  connect_bd_intf_net -intf_net random_number_generator_m00_axis [get_bd_intf_pins random_number_generator/m00_axis] [get_bd_intf_pins sd_fec_ctrl_encoder/s_axis]
  connect_bd_intf_net -intf_net random_number_generator_m01_axis [get_bd_intf_pins ber/s_axis_orig] [get_bd_intf_pins random_number_generator/m01_axis]
  connect_bd_intf_net -intf_net sd_fec_ctrl_decoder_m_axis [get_bd_intf_pins sd_fec_ctrl_decoder/m_axis] [get_bd_intf_pins sd_fec_dec/S_AXIS_DIN]
  connect_bd_intf_net -intf_net sd_fec_ctrl_decoder_m_axis_ctrl [get_bd_intf_pins sd_fec_ctrl_decoder/m_axis_ctrl] [get_bd_intf_pins sd_fec_dec/S_AXIS_CTRL]
  connect_bd_intf_net -intf_net sd_fec_ctrl_encoder_m_axis [get_bd_intf_pins sd_fec_ctrl_encoder/m_axis] [get_bd_intf_pins sd_fec_enc/S_AXIS_DIN]
  connect_bd_intf_net -intf_net sd_fec_ctrl_encoder_m_axis_ctrl [get_bd_intf_pins sd_fec_ctrl_encoder/m_axis_ctrl] [get_bd_intf_pins sd_fec_enc/S_AXIS_CTRL]
  connect_bd_intf_net -intf_net sd_fec_dec_M_AXIS_DOUT [get_bd_intf_pins ber/s_axis_decoded] [get_bd_intf_pins sd_fec_dec/M_AXIS_DOUT]
  connect_bd_intf_net -intf_net sd_fec_dec_M_AXIS_STATUS [get_bd_intf_pins sd_fec_ctrl_decoder/s_axis_status] [get_bd_intf_pins sd_fec_dec/M_AXIS_STATUS]
  connect_bd_intf_net -intf_net sd_fec_enc_M_AXIS_DOUT [get_bd_intf_pins qam_mapping/AXI4_Stream_Slave] [get_bd_intf_pins sd_fec_enc/M_AXIS_DOUT]
  connect_bd_intf_net -intf_net sd_fec_enc_M_AXIS_STATUS [get_bd_intf_pins sd_fec_ctrl_encoder/s_axis_status] [get_bd_intf_pins sd_fec_enc/M_AXIS_STATUS]
  connect_bd_intf_net -intf_net soft_demodulation_AXI4_Stream_Master [get_bd_intf_pins sd_fec_ctrl_decoder/s_axis] [get_bd_intf_pins soft_demodulation/AXI4_Stream_Master]

  # Create port connections
  connect_bd_net -net M00_ACLK_1 [get_bd_pins axi_interconnect_ps_master/ACLK] [get_bd_pins axi_interconnect_ps_master/S00_ACLK] [get_bd_pins rst_pl_clk0/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0]
  connect_bd_net -net axi_intc_0_irq [get_bd_pins axi_intc_0/irq] [get_bd_pins zynq_ultra_ps_e_0/pl_ps_irq0]
  connect_bd_net -net clk_wiz_0_clk_667M [get_bd_pins clk_wiz_0/clk_640M] [get_bd_pins rst_design_1_640M/slowest_sync_clk] [get_bd_pins sd_fec_dec/core_clk] [get_bd_pins sd_fec_enc/core_clk]
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins awgn_channel/AXI4_Lite_ACLK] [get_bd_pins awgn_channel/IPCORE_CLK] [get_bd_pins axi_intc_0/s_axi_aclk] [get_bd_pins axi_interconnect_ps_master/M00_ACLK] [get_bd_pins axi_interconnect_ps_master/M01_ACLK] [get_bd_pins axi_interconnect_ps_master/M02_ACLK] [get_bd_pins axi_interconnect_ps_master/M03_ACLK] [get_bd_pins axi_interconnect_ps_master/M04_ACLK] [get_bd_pins axi_interconnect_ps_master/M05_ACLK] [get_bd_pins axi_interconnect_ps_master/M06_ACLK] [get_bd_pins axi_interconnect_ps_master/M07_ACLK] [get_bd_pins axi_interconnect_ps_master/M08_ACLK] [get_bd_pins axi_interconnect_ps_master/M09_ACLK] [get_bd_pins ber/AXI4_Lite_ACLK] [get_bd_pins ber/IPCORE_CLK] [get_bd_pins clk_wiz_0/clk_320M] [get_bd_pins qam_mapping/AXI4_Lite_ACLK] [get_bd_pins qam_mapping/IPCORE_CLK] [get_bd_pins random_number_generator/AXI4_Lite_ACLK] [get_bd_pins random_number_generator/IPCORE_CLK] [get_bd_pins rst_clk_wiz_320M/slowest_sync_clk] [get_bd_pins sd_fec_ctrl_decoder/AXI4_Lite_ACLK] [get_bd_pins sd_fec_ctrl_decoder/IPCORE_CLK] [get_bd_pins sd_fec_ctrl_encoder/AXI4_Lite_ACLK] [get_bd_pins sd_fec_ctrl_encoder/IPCORE_CLK] [get_bd_pins sd_fec_dec/m_axis_dout_aclk] [get_bd_pins sd_fec_dec/m_axis_status_aclk] [get_bd_pins sd_fec_dec/s_axi_aclk] [get_bd_pins sd_fec_dec/s_axis_ctrl_aclk] [get_bd_pins sd_fec_dec/s_axis_din_aclk] [get_bd_pins sd_fec_enc/m_axis_dout_aclk] [get_bd_pins sd_fec_enc/m_axis_status_aclk] [get_bd_pins sd_fec_enc/s_axi_aclk] [get_bd_pins sd_fec_enc/s_axis_ctrl_aclk] [get_bd_pins sd_fec_enc/s_axis_din_aclk] [get_bd_pins soft_demodulation/AXI4_Lite_ACLK] [get_bd_pins soft_demodulation/IPCORE_CLK]
  connect_bd_net -net clk_wiz_0_locked [get_bd_pins clk_wiz_0/locked] [get_bd_pins rst_clk_wiz_320M/dcm_locked] [get_bd_pins rst_design_1_640M/dcm_locked] [get_bd_pins rst_pl_clk0/dcm_locked]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins awgn_channel/AXI4_Lite_ARESETN] [get_bd_pins awgn_channel/IPCORE_RESETN] [get_bd_pins axi_intc_0/s_axi_aresetn] [get_bd_pins axi_interconnect_ps_master/M00_ARESETN] [get_bd_pins axi_interconnect_ps_master/M01_ARESETN] [get_bd_pins axi_interconnect_ps_master/M02_ARESETN] [get_bd_pins axi_interconnect_ps_master/M03_ARESETN] [get_bd_pins axi_interconnect_ps_master/M04_ARESETN] [get_bd_pins axi_interconnect_ps_master/M05_ARESETN] [get_bd_pins axi_interconnect_ps_master/M06_ARESETN] [get_bd_pins axi_interconnect_ps_master/M07_ARESETN] [get_bd_pins axi_interconnect_ps_master/M08_ARESETN] [get_bd_pins axi_interconnect_ps_master/M09_ARESETN] [get_bd_pins ber/AXI4_Lite_ARESETN] [get_bd_pins ber/IPCORE_RESETN] [get_bd_pins qam_mapping/AXI4_Lite_ARESETN] [get_bd_pins qam_mapping/IPCORE_RESETN] [get_bd_pins random_number_generator/AXI4_Lite_ARESETN] [get_bd_pins random_number_generator/IPCORE_RESETN] [get_bd_pins rst_clk_wiz_320M/peripheral_aresetn] [get_bd_pins sd_fec_ctrl_decoder/AXI4_Lite_ARESETN] [get_bd_pins sd_fec_ctrl_decoder/IPCORE_RESETN] [get_bd_pins sd_fec_ctrl_encoder/AXI4_Lite_ARESETN] [get_bd_pins sd_fec_ctrl_encoder/IPCORE_RESETN] [get_bd_pins soft_demodulation/AXI4_Lite_ARESETN] [get_bd_pins soft_demodulation/IPCORE_RESETN]
  connect_bd_net -net rst_design_1_640M_peripheral_aresetn [get_bd_pins rst_design_1_640M/peripheral_aresetn] [get_bd_pins sd_fec_dec/reset_n] [get_bd_pins sd_fec_enc/reset_n]
  connect_bd_net -net rst_pl_clk0_interconnect_aresetn [get_bd_pins axi_interconnect_ps_master/ARESETN] [get_bd_pins rst_pl_clk0/interconnect_aresetn]
  connect_bd_net -net rst_pl_clk0_peripheral_aresetn [get_bd_pins axi_interconnect_ps_master/S00_ARESETN] [get_bd_pins rst_pl_clk0/peripheral_aresetn]
  connect_bd_net -net sd_fec_enc1_interrupt [get_bd_pins sd_fec_dec/interrupt] [get_bd_pins xlconcat_intr/In1]
  connect_bd_net -net sd_fec_enc_interrupt [get_bd_pins sd_fec_enc/interrupt] [get_bd_pins xlconcat_intr/In0]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins axi_intc_0/intr] [get_bd_pins xlconcat_intr/dout]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_resetn0 [get_bd_pins clk_wiz_0/resetn] [get_bd_pins rst_clk_wiz_320M/ext_reset_in] [get_bd_pins rst_design_1_640M/ext_reset_in] [get_bd_pins rst_pl_clk0/ext_reset_in] [get_bd_pins zynq_ultra_ps_e_0/pl_resetn0]

  # Create address segments
  assign_bd_address -offset 0xA0000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs awgn_channel/AXI4_Lite/reg0] -force
  ...
  assign_bd_address -offset 0xA0010000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs ber/AXI4_Lite/reg0] -force
  assign_bd_address -offset 0xA0020000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs qam_mapping/AXI4_Lite/reg0] -force
  assign_bd_address -offset 0xA0040000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs random_number_generator/AXI4_Lite/reg0] -force
  assign_bd_address -offset 0xA0050000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs sd_fec_ctrl_decoder/AXI4_Lite/reg0] -force
  assign_bd_address -offset 0xA0060000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs sd_fec_ctrl_encoder/AXI4_Lite/reg0] -force
  ...
  assign_bd_address -offset 0xA00C0000 -range 0x00040000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs sd_fec_enc/S_AXI/PARAMS] -force
  assign_bd_address -offset 0xA0070000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs soft_demodulation/AXI4_Lite/reg0] -force
