...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net default_sysclk1_300mhz_1 [get_bd_intf_ports sys_clk] [get_bd_intf_pins clk_wiz_0/CLK_IN1_D]
  ...
  connect_bd_net -net ARESETN_1 [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins rst_clk_wiz_100M/interconnect_aresetn]
  ...
  connect_bd_net -net zynq_ultra_ps_e_0_pl_resetn0 [get_bd_pins clk_wiz_0/resetn] [get_bd_pins rst_clk_wiz_100M/ext_reset_in] [get_bd_pins rst_pl_clk/ext_reset_in] [get_bd_pins zynq_ultra_ps_e_0/pl_resetn0]
