...
proc create_root_design { parentCell } {
  ...
  # Create port connections
  connect_bd_net -net M00_ACLK_1 [get_bd_pins axi_interconnect_ps_master/ACLK] [get_bd_pins axi_interconnect_ps_master/S00_ACLK] [get_bd_pins axi_interconnect_ps_slave/ACLK] [get_bd_pins axi_interconnect_ps_slave/M00_ACLK] [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins rst_pl_clk0/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins zynq_ultra_ps_e_0/saxihp0_fpd_aclk]
  connect_bd_net -net axi_intc_0_irq [get_bd_pins axi_intc_0/irq] [get_bd_pins zynq_ultra_ps_e_0/pl_ps_irq0]
  connect_bd_net -net clk_wiz_0_clk_667M [get_bd_pins clk_wiz_0/clk_out2] [get_bd_pins ldpc_decoder/clk_667M] [get_bd_pins ldpc_encoder/clk_667M]
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins axi_intc_0/s_axi_aclk] [get_bd_pins axi_interconnect_ps_master/M00_ACLK] [get_bd_pins axi_interconnect_ps_master/M01_ACLK] [get_bd_pins axi_interconnect_ps_master/M02_ACLK] [get_bd_pins axi_interconnect_ps_slave/S00_ACLK] [get_bd_pins axi_interconnect_ps_slave/S01_ACLK] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins ldpc_decoder/clk_50M] [get_bd_pins ldpc_encoder/clk_50M] [get_bd_pins rst_clk_wiz_50M/slowest_sync_clk]
